...
import { Zap, Loader2, Trash } from 'lucide-react';
import { clsx } from 'clsx';

export default function Controls({ count, onClear, onMerge, isMerging }) {
    return (
        <motion.div
        ...
        >
            ...
            <button
                ...
                className={clsx(
                    "w-full sm:w-auto relative group overflow-hidden px-8 py-3 rounded-xl font-bold text-white shadow-lg transition-all duration-300",
                    isMerging || count < 1
